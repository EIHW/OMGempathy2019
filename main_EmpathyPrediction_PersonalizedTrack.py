...
# FUNCTION CALL: 
# --------------
# $ python main_EmpathyPrediction_PersonalizedTrack.py -action arg1 -model arg2 -ml arg3 [-dw arg4 -LSTMunits arg5 -bs arg6 -p arg7]
#
...
import os
import sys
import module_MachineLearning_PersonalizedTrack as ML
